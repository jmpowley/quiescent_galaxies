...
def create_nirspec_fits_for_objid(src_id, src_name, out_dir, table_url, cache_downloads):
    ...
    for (root, file, grating, filt) in zip(roots, files, gratings, filters):
        ...
        # Save file
        out_name = f"{src_name}_nirspec_{grating.lower()}_{filt.lower()}_1D.fits"
...
def main():
    ...
    # Source information
    src_id = 55410  # source ID in DJA
    src_name = 'zf-uds-7329'  # name of source
    out_dir = f"/Users/Jonah/PhD/Research/quiescent_galaxies/data_processed/zf-uds-7329/spectra"  # where to save
